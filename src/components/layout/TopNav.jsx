...
export default function TopNav({ view, onViewChange, onMenuClick }) {
  const title = usePageTitle()

  return (
    <header className="h-14 shrink-0 flex items-center gap-4 px-4 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800">
      ...
      {/* +New button */}
      <button className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-xs font-medium px-3 py-2 rounded-lg transition-colors">
